...
public class CustomNotification extends ContextWrapper {
    ...
    private static final String CHANNEL_NAME = "Notification new message";
    ...
    private void createChannel() {
        ...
        getManagerNotification().createNotificationChannel(channel);
    }

    public NotificationManager getManagerNotification() {
